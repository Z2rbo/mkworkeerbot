...
Мне 16 лет, и я занимаюсь дизайном курсов, монтажом рилсов и созданием Telegram-ботов.
...
📈 Контент — 15к подписчиков на YouTube за 10 видео!
...
Делаю крутой визуал для инфопродуктов!
...
_Работал с блогерами-миллиониками!_
    """,
    
    "development_info": """
🎬 *Монтаж рилсов и шортсов*

Делаю вирусные ролики, которые залетают!
...
Знаю как делать контент, который залетает!
...
Мне 16 лет, учусь в школе и параллельно занимаюсь крутыми проектами 🚀
